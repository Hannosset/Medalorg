		...
		public static void LoadFromFile()
		{
			if( !File.Exists( Filename ) )
			{
				...
				Info._Details = new List<MediaGenre>()
				{
					...
					new MediaGenre()
					{
						Type = AdaptiveKind.Video , Label = "Experiemental" , Description = "The experimental genre is often defined by the idea that the work of art and entertainment does not fit into a particular genre or sub-genre, and is intended as such. Experimental art can completely forego a cohesive narrative in exchange for an emotional response or nothing at all. ",
						Details = new MediaGenre.MediaStyle[]
						{
					...
					new MediaGenre()
					{
						Type = AdaptiveKind.Audio , Label = "Avant-garde & Experimental" , Description = "",
						Details = new MediaGenre.MediaStyle[]
						{
					...
					new MediaGenre()
					{
						Type = AdaptiveKind.Audio , Label = "Blues" , Description = "",
						Details = new MediaGenre.MediaStyle[]
						{
						}
					},
					...
					new MediaGenre()
					{
						Type = AdaptiveKind.Audio , Label = "Easy Listening" , Description = "",
						Details = new MediaGenre.MediaStyle[]
						{
						}
					},
					new MediaGenre()
					{
						Type = AdaptiveKind.Audio , Label = "Electronic" , Description = "",
						Details = new MediaGenre.MediaStyle[]
						{
						}
					},
					new MediaGenre()
					{
						Type = AdaptiveKind.Audio , Label = "Folk" , Description = "Folk music has existed in many different parts of the world for centuries. Traditionally, this genre is essentially built upon people gathering to sing and play songs with others in their community.",
						Details = new MediaGenre.MediaStyle[]
						{
						}
					},
					...
					new MediaGenre()
					{
						Type = AdaptiveKind.Audio , Label = "Punk" , Description = "",
						Details = new MediaGenre.MediaStyle[]
						{
